...
Modified the code so that it was not polluting the global scope anymore.  Also added in a precision feature so that user could automatically get back a substring of the full geohash.
Added small test file.

## Example Usage

```javascript
geohash.setPrecision(4);
var nycGeoHash = geohash.encodeGeoHash(40.7056308,-73.9780035);
console.log(nycGeoHash);
```
We should expect it to print 'dr5r'
